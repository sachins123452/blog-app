...
import '../../../pages/order/components/SelectedProductTable.css';
import { useTheme } from 'components/Theme/ThemeProvider';

function AddInventorySelectedProductTable({ product, borderRadius, BtnSubtitle, BtnTitle, onClick }) {
...
export default AddInventorySelectedProductTable;

AddInventorySelectedProductTable.defaultProps = {
  borderRadius: '15px',
  // onClick:onClick,
  BtnTitle: 'MyCart',
