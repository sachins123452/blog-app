...
function CreateStockTransferSelectedTable({ product, borderRadius, BtnSubtitle, BtnTitle, onClick }) {
...
export default CreateStockTransferSelectedTable;

CreateStockTransferSelectedTable.defaultProps = {
  borderRadius: '15px',
  // onClick:onClick,
  BtnTitle: 'MyCart',
